# Wine Quality Workspace documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = "Wine Quality Workspace"
...
htmlhelp_basename = "wine_quality_workspacedoc"
...
texinfo_documents = [
    (
        ...
        "Data science workspace for Kaggle wine-quality dataset",
        "Miscellaneous",
    ),
]
